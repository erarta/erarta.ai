...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function(t, e) {
        ...
        var n = [],
            r = [],
            s = null;
        t.MOBILE ? (t.FLOW = t.FLOWS.MOBILE, r.push(t.CDN + "/css/all_mobile.css"), n.push("main_mobile", "text!/Resn/index_mobile.html!strip")) : t.OLD_DESKTOP ? (t.FLOW = t.FLOWS.BASIC, r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip")) : t.TABLET ? (t.FLOW = t.FLOWS.TABLET, r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip")) : (t.FLOW = t.FLOWS.EXTENDED, r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip")),
            function(t) {
